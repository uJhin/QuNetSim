...
def main():
    ...
    # Enbale statistics logging
    host_alice.store_statistics = True
    host_bob.store_statistics = True
    host_eve.store_statistics = True
    ...
    host_alice.statisitic_storage.dump_as_csv("./alice.csv")
    host_bob.statisitic_storage.dump_as_csv("./bob.csv")
    host_eve.statisitic_storage.dump_as_csv("./eve.csv")
